...
if decibels > 0 and decibels < 40:
    print('Your sound level is quieter than a quiet room.')
		
elif decibels == 40:
    print('Your sound level is about the same as a quiet room.')
	
elif decibels > 40 and decibels < 70:
    print('Your sound level is quieter than an alarm clock.')
elif decibels == 70:
    print('Your sound level is about the same as an alarm clock.')
		
elif decibels > 70 and decibels < 106:
    print('Your sound level is quieter than a lawn mower.')
	
elif decibels == 106:
    ('Your sound level is about the same as a lawn mower.')
	
elif decibels > 106 and decibels < 130:
    print("Your sound level is quieter than a jackhammer.")
		
elif decibels == 130:
    print('Your sound level is about the same as a jackhammer.')
		
elif decibels > 130:
    print('Your sound is too loud.')
